...
var polygon = new RenderPolygon(new Vector2Float[] { new(-50, 0), new(-20, -20), new(50, 0), new(0, 50) }, new Vector2Float(100, 100), Angle.ofDegree(0), Color.WHITE);

window.OnFixedUpdate += () =>
{
    polygon.Rotation += Angle.ofDegree(2);
};
